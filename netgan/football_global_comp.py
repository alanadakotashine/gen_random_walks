...
X = np.loadtxt('plots/football_walk_em/trainingIteration_1200_expectedGraph.txt')
print('Random Walks Size 16')
global_comp(A_matrix,X,sps_truth,spec_truth)
print(auc_p(X,np.asarray(A_matrix),valid))
X = np.loadtxt('plots/football_edge_em_nbs/trainingIteration_3200_expectedGraph.txt')
print('Random Walks Size 2 No BS adj')
global_comp(A_matrix,X,sps_truth,spec_truth)
print(auc_p(X,np.asarray(A_matrix),valid))
X = np.loadtxt('plots/football_edge_em_adj_bs/trainingIteration_1200_expectedGraph.txt')
