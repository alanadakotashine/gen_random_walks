...
valid_edges = np.loadtxt('plots/dolphins_val_edges.txt').tolist()
valid_nonEdges = np.loadtxt('plots/dolphins_val_non_edges.txt').tolist()
...
X = np.loadtxt('plots/dolphins_walk_em/trainingIteration_1000_expectedGraph.txt')
print('Random Walks Size 16')
print(global_comp(A_matrix,X,sps_truth,spec_truth))
print(auc_p(X,np.asarray(A_matrix),valid))
X = np.loadtxt('plots/dolphins_edge_nbs_em/trainingIteration_1400_expectedGraph.txt')
print('Random Walks Size 2 No BS adj')
print(global_comp(A_matrix,X,sps_truth,spec_truth))
print(auc_p(X,np.asarray(A_matrix),valid))
X = np.loadtxt('plots/trainingIteration_400_expectedGraph.txt')
